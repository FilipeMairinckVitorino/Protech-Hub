export const linkAPI_users = 'https://bfcuurcqtcbawwlvknwg.supabase.co/rest/v1/Alunos'
export const linkAPI_apostilas = 'https://bfcuurcqtcbawwlvknwg.supabase.co/rest/v1/Apostilas'
export const linkAPI_atividades = 'https://bfcuurcqtcbawwlvknwg.supabase.co/rest/v1/Atividades'
export const linkAPI_atividades_concluidas = 'https://bfcuurcqtcbawwlvknwg.supabase.co/rest/v1/Atividades_concluidas'
export const chaveAPI = 'sb_publishable_cSCl-_IxbhwdAmoK1Z5iWw_6cU33Ch1'
